...
@protocol BookManagerMainHeaderViewDelegate <NSObject>
...
@interface BookManagerMainHeaderView : UIView

@property (nonatomic, weak) id<BookManagerMainHeaderViewDelegate> delegate;
